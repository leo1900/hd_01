    ...
    public class DownloadManager : Manager<DownloadManager>
    {
        ...
        public void AbortDownloadTask (DownloadingTask task)
        {
            if (task != null)
            {
                ...
                if (headRequest != null)
                {
                    long headstarttime = Utils.TotalMilliseconds();
                    ...
                    long headbistarttime = Utils.TotalMilliseconds();
                    headRequest.Abort();
                    long headaborttime = Utils.TotalMilliseconds();
                ...
                {
                    long taskstarttime = Utils.TotalMilliseconds();
                    ...
                    long taskbistarttime = Utils.TotalMilliseconds();
                    task.Downloader.CancelDownload(false);
                    long tastaborttime = Utils.TotalMilliseconds();
        ...
        public void AbortAllDownloadTask()
        {
            ...
            long totalstarttime = Utils.TotalMilliseconds();
            ...
            long starttime = Utils.TotalMilliseconds();
            for (int i = 0; i < list.Count; i++)
            {
                long loopstarttime = Utils.TotalMilliseconds();
                AbortDownloadTask(list[i]);
                long loopendtime = Utils.TotalMilliseconds();

                //DebugUtil.LogError("Download Downloading loop {0} time is {1}", i, (loopendtime - loopstarttime));
            }
            long endtime = Utils.TotalMilliseconds();
            ...
            pendingDownloads.Clear();
            downloadThreads = 0;
            long totalendtime = Utils.TotalMilliseconds();
